...
public class Funcionarios extends javax.swing.JFrame {
    ...
    Frentista frent = new Frentista(IDfrentista, Nome.getText());
    addFren.adiciona(frent);
    JOptionPane.showMessageDialog(this,"Frentista "+ Nome.getText()+ " adicionado");
    IDFrentista.setText("");
    Nome.setText("");
    ...
    int IDfrentista = Integer.parseInt(IDFrentista.getText());
    FrentistaDAO delFren = new FrentistaDAO();
    delFren.deleta(IDfrentista);
    JOptionPane.showMessageDialog(this,"Frentista "+ Nome.getText()+ " Removido");
    IDFrentista.setText("");
    Nome.setText("");
